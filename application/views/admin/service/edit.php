				      	...
				      	<div class="row">
				      		<div class="form-group">
								...
								<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
									<input type="text" class="" name="name" value="<?php echo $info->TENDV ?>">
							...
							<br>
				      		<div class="form-group">
								...
								<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
									<input type="text" class="" name="dvt" value="<?php echo $info->DVT ?>">
							...
							<div class="form-group">
								...
								<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
									<input type="text" class="" name="price" value="<?php echo $info->DONGIA ?>">
